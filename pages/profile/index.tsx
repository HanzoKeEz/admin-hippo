		...
		<>
			...
			<section className='px-8 pb-[5%] md:px-[10%] pt-[5%] md:pb-0 min-h-screen w-full text-gray-800 bg-primary-grey'>
				<div className='mb-[5rem] flex items-center justify-between'>
					...
					<button
						onClick={onLogout}
						className='py-2 px-5 bg-primary-indigo text-primary-white rounded-2xl font-semibold hover:opacity-50'
					>
						Logout
					</button>
				</div>
				<form className='max-w-[600px] mb-12 space-y-5'>
					...
					<div className='flex items-center justify-between'>
						...
						<button
							className='text-primary-indigo font-semibold'
							type='button'
				...
				<div className='mt-[5rem]'>
					...
					{loading ? (
						<div className='h-12 w-12 border-t-transparent block border-solid border rounded-[50%] border-primary-indigo animate-spin'></div>
						...
						<div className='h-[150px]   text-center '>
							...
							<p className='text-gray-400  mt-4 text-center'>
								...
								<Link
									href='/create-listing'
									className='text-indigo-500 opacity-100 font-semibold'
								>
