...
function NavBar() {
	...
	return (
		<nav className='fixed max-md:bottom-0 h-[110px] z-[900] py-5 px-3 w-full border-t border-[#aaaeaa] md:border-r md:border-t-0 md:left-0  md:h-screen md:w-[250px] md:py-8 bg-primary-white'>
